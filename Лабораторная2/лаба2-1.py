...
def months_until_debt(total_money_capital, monthly_salary, monthly_spending, price_increase_rate):
    if monthly_salary <= monthly_spending:
        # Если зарплата меньше или равна расходам, то проверяем бюджет на покрытие долгов
...
# Рассчитываем количество месяцев, которое можно протянуть без долгов
